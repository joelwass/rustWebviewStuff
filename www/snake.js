...
var _user$project$Model$_p0 = {ctor: '_Tuple2', _0: 300, _1: 200};
var _user$project$Model$halfWidth = _user$project$Model$_p0._0;
var _user$project$Model$halfHeight = _user$project$Model$_p0._1;
var _user$project$Model$_p1 = {ctor: '_Tuple2', _0: 600, _1: 400};
var _user$project$Model$gameWidth = _user$project$Model$_p1._0;
var _user$project$Model$gameHeight = _user$project$Model$_p1._1;
var _user$project$Model$Ball = F4(
	function (a, b, c, d) {
		return {x: a, y: b, vx: c, vy: d};
	});
var _user$project$Model$Player = F6(
	function (a, b, c, d, e, f) {
		return {x: a, y: b, vx: c, vy: d, dir: e, score: f};
	});
var _user$project$Model$player = function (x) {
	return A6(_user$project$Model$Player, x, 0, 0, 0, 0, 0);
};
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {state: a, ball: b, player1: c, player2: d, size: e};
	});
var _user$project$Model$Pause = {ctor: 'Pause'};
var _user$project$Model$defaultModel = {
	state: _user$project$Model$Pause,
	ball: A4(_user$project$Model$Ball, 0, 0, 200, 200),
	player1: _user$project$Model$player(20 - _user$project$Model$halfWidth),
	player2: _user$project$Model$player(_user$project$Model$halfWidth - 20),
	size: A2(_elm_lang$window$Window$Size, 0, 0)
};
var _user$project$Model$Play = {ctor: 'Play'};
var _user$project$Update$stepV = F3(
...
var _user$project$Update$near = F3(
	function (k, c, n) {
		return (_elm_lang$core$Native_Utils.cmp(n, k - c) > -1) && (_elm_lang$core$Native_Utils.cmp(n, k + c) < 1);
	});
var _user$project$Update$within = F2(
	function (paddle, ball) {
		return A3(_user$project$Update$near, paddle.x, 8, ball.x) && A3(_user$project$Update$near, paddle.y, 20, ball.y);
	});
var _user$project$Update$physicsUpdate = F2(
	function (dt, obj) {
		return _elm_lang$core$Native_Utils.update(
			obj,
			{x: obj.x + (obj.vx * dt), y: obj.y + (obj.vy * dt)});
	});
var _user$project$Update$updatePlayer = F3(
	function (dt, points, player) {
		var movedPlayer = A2(
			_user$project$Update$physicsUpdate,
			dt,
			_elm_lang$core$Native_Utils.update(
				player,
				{
					vy: _elm_lang$core$Basics$toFloat(player.dir) * 600
				}));
		return _elm_lang$core$Native_Utils.update(
			movedPlayer,
			{
				y: A3(_elm_lang$core$Basics$clamp, 22 - _user$project$Model$halfHeight, _user$project$Model$halfHeight - 22, movedPlayer.y),
				score: player.score + points
			});
	});
var _user$project$Update$updateBall = F4(
	function (dt, ball, paddle1, paddle2) {
		return _elm_lang$core$Basics$not(
			A3(_user$project$Update$near, 0, _user$project$Model$halfWidth, ball.x)) ? _elm_lang$core$Native_Utils.update(
			ball,
			{x: 0, y: 0}) : A2(
			_user$project$Update$physicsUpdate,
			dt,
			_elm_lang$core$Native_Utils.update(
				...
				{
					vx: A3(
						_user$project$Update$stepV,
						ball.vx,
						A2(_user$project$Update$within, paddle1, ball),
						A2(_user$project$Update$within, paddle2, ball)),
					vy: A3(
						_user$project$Update$stepV,
						ball.vy,
						_elm_lang$core$Native_Utils.cmp(ball.y, 7 - _user$project$Model$halfHeight) < 0,
						_elm_lang$core$Native_Utils.cmp(ball.y, _user$project$Model$halfHeight - 7) > 0)
				}));
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Player1':
				var _p1 = model;
				var player1 = _p1.player1;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						player1: _elm_lang$core$Native_Utils.update(
							player1,
							{dir: _p0._0})
					});
			case 'Player2':
				var _p2 = model;
				var player2 = _p2.player2;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						player2: _elm_lang$core$Native_Utils.update(
							player2,
							{dir: _p0._0})
					});
			case 'TogglePlay':
				var newState = function () {
					var _p3 = model.state;
					if (_p3.ctor === 'Play') {
						return _user$project$Model$Pause;
					} else {
						return _user$project$Model$Play;
					}
				}();
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			default:
				...
				var state = _p4.state;
				var ball = _p4.ball;
				var player1 = _p4.player1;
				var player2 = _p4.player2;
				var score1 = (_elm_lang$core$Native_Utils.cmp(ball.x, _user$project$Model$halfWidth) > 0) ? 1 : 0;
				var score2 = (_elm_lang$core$Native_Utils.cmp(ball.x, 0 - _user$project$Model$halfWidth) < 0) ? 1 : 0;
				var newState = (!_elm_lang$core$Native_Utils.eq(score1, score2)) ? _user$project$Model$Pause : state;
				var newBall = _elm_lang$core$Native_Utils.eq(state, _user$project$Model$Pause) ? ball : A4(_user$project$Update$updateBall, _p5, ball, player1, player2);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						state: newState,
						ball: newBall,
						player1: A3(_user$project$Update$updatePlayer, _p5, score1, player1),
						player2: A3(_user$project$Update$updatePlayer, _p5, score2, player2)
					});
		}
	});
var _user$project$Update$NoOp = {ctor: 'NoOp'};
var _user$project$Update$TogglePlay = {ctor: 'TogglePlay'};
var _user$project$Update$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Update$Player2 = function (a) {
	return {ctor: 'Player2', _0: a};
};
var _user$project$Update$Player1 = function (a) {
	return {ctor: 'Player1', _0: a};
};
var _user$project$Update$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$View$make = F2(
	function (obj, shape) {
		return A2(
...
var _user$project$View$msg = 'SPACE to start, WS and &uarr;&darr; to move';
var _user$project$View$textGreen = A3(_elm_lang$core$Color$rgb, 160, 200, 160);
var _user$project$View$txt = F2(
	function (f, string) {
		return _evancz$elm_graphics$Element$leftAligned(
			f(
				_evancz$elm_graphics$Text$monospace(
					A2(
						...
						_user$project$View$textGreen,
						_evancz$elm_graphics$Text$fromString(string)))));
	});
var _user$project$View$pongGreen = A3(_elm_lang$core$Color$rgb, 60, 100, 60);
var _user$project$View$view = function (model) {
	...
	var ball = _p1.ball;
	var player1 = _p1.player1;
	var player2 = _p1.player2;
	var state = _p1.state;
	var scores = A2(
		_user$project$View$txt,
		_evancz$elm_graphics$Text$height(50),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(player1.score),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'  ',
				_elm_lang$core$Basics$toString(player2.score))));
	return _evancz$elm_graphics$Element$toHtml(
		A4(
			...
			A3(
				...
				_user$project$Model$gameWidth,
				_user$project$Model$gameHeight,
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_evancz$elm_graphics$Collage$filled,
						_user$project$View$pongGreen,
						A2(_evancz$elm_graphics$Collage$rect, _user$project$Model$gameWidth, _user$project$Model$gameHeight)),
						A2(
						_user$project$View$make,
						ball,
						...
						A2(
						_evancz$elm_graphics$Collage$move,
						{ctor: '_Tuple2', _0: 0, _1: (_user$project$Model$gameHeight / 2) - 40},
						_evancz$elm_graphics$Collage$toForm(scores)),
						A2(
						_evancz$elm_graphics$Collage$move,
						{ctor: '_Tuple2', _0: 0, _1: 40 - (_user$project$Model$gameHeight / 2)},
						_evancz$elm_graphics$Collage$toForm(
							_elm_lang$core$Native_Utils.eq(state, _user$project$Model$Play) ? A2(_evancz$elm_graphics$Element$spacer, 1, 1) : A2(_user$project$View$txt, _elm_lang$core$Basics$identity, _user$project$View$msg)))
					]))));
};
var _user$project$Main$keyboardProcessor = F2(
	function (down, keyCode) {
		var _p0 = {ctor: '_Tuple2', _0: down, _1: keyCode};
		_v0_9:
		do {
			if (_p0.ctor === '_Tuple2') {
				if (_p0._0 === true) {
					switch (_p0._1) {
						case 87:
							return _user$project$Update$Player1(1);
						case 83:
							return _user$project$Update$Player1(-1);
						case 38:
							return _user$project$Update$Player2(1);
						case 40:
							return _user$project$Update$Player2(-1);
						default:
							break _v0_9;
					...
					switch (_p0._1) {
						case 87:
							return _user$project$Update$Player1(0);
						case 83:
							return _user$project$Update$Player1(0);
						case 38:
							return _user$project$Update$Player2(0);
						case 40:
							return _user$project$Update$Player2(0);
						case 32:
							return _user$project$Update$TogglePlay;
						default:
							break _v0_9;
					}
				}
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			update: F2(
				function (msg, m) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_user$project$Update$update, msg, m),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}),
			...
			subscriptions: function (_p2) {
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$window$Window$resizes(_user$project$Update$Resize),
							_elm_lang$keyboard$Keyboard$downs(
							_user$project$Main$keyboardProcessor(true)),
							_elm_lang$keyboard$Keyboard$ups(
							_user$project$Main$keyboardProcessor(false)),
							_elm_lang$animation_frame$AnimationFrame$diffs(
							function (_p3) {
								return _user$project$Update$Tick(
